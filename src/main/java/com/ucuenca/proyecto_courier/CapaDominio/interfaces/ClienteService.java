...
public interface ClienteService {
    ...
    void crearCliente(ClienteDTO cliente, String contrasena);
    ...
    ClienteEnviosDTO obtenerListadoPaquetesPorIdCliente(String id, ConfiguracionDTO configuracion);

    ClienteDTO validarLogin(ClienteDTO cliente, String contrasena);
}
